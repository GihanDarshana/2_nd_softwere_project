...
Route::get('/admin_register', 'Auth\UserRegisterController@showRegisterForm')->name('admin.register');
Route::post('/admin_register', 'Auth\UserRegisterController@register')->name('user.register.submit');
...
Route::get('/editor', 'UserController@editordashboard')->middleware('editor','revalidate');
